import 'package:db_racitel/plans/sub_plan.dart';
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontWeight: switcherIndex1 == 0
                            ...
                            : FontWeight.w400,
                        color:
                            switcherIndex1 == 0 ? Colors.white : Colors.white,
                      ),
                    ),
                    Text(
                      'Commercial Plan',
                    ...
                    child: Column(
                      children: [
                        ...
                        const Text(
                          ...
                          textAlign: TextAlign.center,
                          style:
                              TextStyle(color: Color(0XFF6286CB), fontSize: 14),
                        ),
                        SizedBox(
                        ...
                        MaterialButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const SubscribePlanPage(),
                              ),
                            );
                          },
                          child: const Text(
